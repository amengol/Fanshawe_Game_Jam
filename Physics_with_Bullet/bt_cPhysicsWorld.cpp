...
namespace nPhysics
{
	...
	void bt_cPhysicsWorld::TimeStep(float deltaTime)
	{
        ...
        {
            bt_cRigidBody* rb1 = mRigidBody[i];
            ...
            case nPhysics::SHAPE_TYPE_SPHERE:
            {
                ...
                {
                    bt_cRigidBody* rb2 = mRigidBody[j];
                    bt_cSphereShape* sphere1 = static_cast<bt_cSphereShape*>(sh1);
                    ...
                    if (rb1 != rb2)
                    {
                        ...
                        if (sh2->GetShapeType() == SHAPE_TYPE_PLANE)
                        {
                            ...
                            bt_cPlaneShape* plane = static_cast<bt_cPlaneShape*>(sh2);
                        ...
                        if (sh2->GetShapeType() == SHAPE_TYPE_SPHERE)
                        {
                            ...
                            bt_cSphereShape* sphere2 = static_cast<bt_cSphereShape*>(sh2);
