...
// Question7 variables
uniform float materialDiffuse_r;
uniform float materialDiffuse_g;
uniform float materialDiffuse_b;
uniform float materialDiffuse_a;
...
void main()
{
	...
	if ( bIsDebugWireFrameObject )
	{
		// This is used for the debug lines, etc.
 		...
 		{
			gl_FragColor.r = materialDiffuse_r;
 			gl_FragColor.g = materialDiffuse_g;
			gl_FragColor.b = materialDiffuse_b;
 			gl_FragColor.a = materialDiffuse_a;
 		}
		// Immediate return
		return;
	}
