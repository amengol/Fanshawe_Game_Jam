...
void cGameObject::DebugUpdate(double deltaTime)
 ...
 bool cGameObject::InitCharacterAnimations(std::string & error)
 {
     ...
     animationName = animations.trick;
     if (animationName != "")
     {
         const aiScene* anim = g_animationCollection.getAnimation(animationName);
     ...
     animationName = animations.violent_trick;
     if (animationName != "")
     {
         const aiScene* anim = g_animationCollection.getAnimation(animationName);
     ...
     animationName = animations.runaway;
     if (animationName != "")
     {
         const aiScene* anim = g_animationCollection.getAnimation(animationName);
     ...
     animationName = animations.praying;
     if (animationName != "")
     {
         const aiScene* anim = g_animationCollection.getAnimation(animationName);
     ...
     animationName = animations.dying;
     if (animationName != "")
     {
         const aiScene* anim = g_animationCollection.getAnimation(animationName);
     ...
     animationName = animations.stunned;
     if (animationName != "")
     {
         const aiScene* anim = g_animationCollection.getAnimation(animationName);
